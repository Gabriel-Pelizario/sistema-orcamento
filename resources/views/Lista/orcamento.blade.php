...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Lista de Orçamentos') }}</h1>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Orçamentos listados</h6>
        </div>
                            ...
                            <table class="table table-bordered dataTable table-hover" id="dataTable" width="100%"
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th rowspan="1" style="width: 13%" colspan="1">Ação</th>
                                    </tr>
                                </tfoot>
                                <tbody>
                                    @foreach ($clientes as $cliente)
                                        <tr class="odd">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form action="/delete/{{ $cliente->id }}" style="display: inline-block"
